...
class DUPX_Bootstrap
{
	...
	const ARCHIVE_FILENAME	 = '20220530_testcymulate_56f6261b1c4a16ee7563_20220530224146_archive.zip';
	const ARCHIVE_SIZE		 = '28588284';
	const INSTALLER_DIR_NAME = 'dup-installer';
	const PACKAGE_HASH		 = '56f6261-30224146';
    const SECONDARY_PACKAGE_HASH = '6adf417-30224146';
	const VERSION			 = '1.4.6';
